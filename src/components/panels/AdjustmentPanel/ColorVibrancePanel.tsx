...
export function ColorVibrancePanel({ layer }: ColorVibrancePanelProps): React.JSX.Element {
    ...
    <div className={styles.content}>
      <div className={styles.row}>
        ...
        <SliderInput
          ...
          inputWidth={40}
          onChange={(v) =>
            dispatch({ type: 'UPDATE_ADJUSTMENT_LAYER', payload: { ...layer, params: { ...layer.params, vibrance: v } } })
          }
        />
      </div>
      <div className={styles.row}>
