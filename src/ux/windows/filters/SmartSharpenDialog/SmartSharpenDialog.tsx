...
import { smartSharpen } from '@/graphicspipeline/webgpu/compute/filterCompute'
...
export function SmartSharpenDialog({
  ...
  return (
    <ToolWindow title="Smart Sharpen" icon={<SmartSharpenIcon />} onClose={handleCancel} width={284}>
